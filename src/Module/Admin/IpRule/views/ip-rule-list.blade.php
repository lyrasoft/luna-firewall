 ...
 * @var  $vm        \Lyrasoft\Firewall\Module\Admin\IpRule\IpRuleListView The view model object.
                ...
                <tr>
                    ...
                    <th style="width: 10%" class="text-nowrap">
                        <x-order-sort
                            ...
                            asc="ip_rule.ordering ASC"
                            desc="ip_rule.ordering DESC">
                        </x-order-sort>
                    </th>
